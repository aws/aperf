...
DataTypes.set('diskstats', new DataType('diskstats', 'diskstatsHide', 'diskstats-button-yes', diskStats, ''));
...
DataTypes.set('systeminfo', new DataType('systeminfo', 'landingChoice', '', systemInfo, ''));
