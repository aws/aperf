...
export function FindingsIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M2 2 L2 14 L14 14" className="stroke-linejoin-round" />
      <path d="M4 11 L4 8" className="stroke-linejoin-round" />
      <path d="M7 11 L7 5" className="stroke-linejoin-round" />
      <path d="M10 11 L10 7" className="stroke-linejoin-round" />
      <path d="M13 11 L13 4" className="stroke-linejoin-round" />
    </svg>
  );
}
